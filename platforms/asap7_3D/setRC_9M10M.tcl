...
# HBV resistance: env var override for DOE sweep (default: 6.30E-02 kOhm)
if {[info exists ::env(HBV_RES_KOHM)] && $::env(HBV_RES_KOHM) ne ""} {
  set_layer_rc -via hb_layer -resistance $::env(HBV_RES_KOHM)
} else {
