...
# place clock buffers (catch failure and continue with legalization)
if {[catch {detailed_placement} err]} {
  puts "WARNING: Detailed placement failed: $err"
  puts "Continuing with legalization only..."
  catch {legalize_placement}
}
...
# Run useful skew optimization if enabled
